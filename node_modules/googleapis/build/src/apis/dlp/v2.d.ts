...
export declare namespace dlp_v2 {
     ...
     */
    interface Schema$GooglePrivacyDlpV2LargeCustomDictionaryStats {
        /**
     ...
     */
    interface Schema$GooglePrivacyDlpV2PublishFindingsToCloudDataCatalog {
    }
    /**
     ...
     */
    interface Schema$GooglePrivacyDlpV2StoredInfoTypeStats {
        /**
         * StoredInfoType where findings are defined by a dictionary of phrases.
         */
    ...
    interface Params$Resource$Projects$Locations$Content$Deidentify extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
