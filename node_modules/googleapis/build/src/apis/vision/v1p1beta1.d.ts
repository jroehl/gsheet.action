...
export declare namespace vision_v1p1beta1 {
     ...
     */
    interface Schema$GoogleCloudVisionV1p1beta1AnnotateFileRequest {
        /**
     ...
     */
    interface Schema$GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest {
        /**
         * Required. The desired output location and metadata (e.g. format).
         */
        outputConfig?: Schema$GoogleCloudVisionV1p1beta1OutputConfig;
     ...
     */
    interface Schema$GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest {
        /**
     ...
     * A list of file annotation responses.
     */
    interface Schema$GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse {
        /**
         * The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest.
         */
