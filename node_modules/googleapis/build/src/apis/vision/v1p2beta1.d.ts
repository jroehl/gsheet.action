...
export declare namespace vision_v1p2beta1 {
     ...
     */
    interface Schema$GoogleCloudVisionV1p2beta1AnnotateFileRequest {
        /**
     ...
     */
    interface Schema$GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest {
        /**
         * Required. The desired output location and metadata (e.g. format).
         */
        outputConfig?: Schema$GoogleCloudVisionV1p2beta1OutputConfig;
     ...
     */
    interface Schema$GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest {
        /**
     ...
     * A list of file annotation responses.
     */
    interface Schema$GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse {
        /**
         * The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest.
         */
