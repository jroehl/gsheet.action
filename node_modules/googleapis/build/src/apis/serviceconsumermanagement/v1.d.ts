...
export declare namespace serviceconsumermanagement_v1 {
     ...
     */
    interface Schema$V1AddVisibilityLabelsResponse {
        /**
     ...
     */
    interface Schema$V1Beta1BatchCreateProducerOverridesResponse {
        /**
     ...
     */
    interface Schema$V1Beta1DisableConsumerResponse {
    }
    /**
     ...
     */
    interface Schema$V1Beta1EnableConsumerResponse {
    }
    /**
     * Response message for ImportProducerOverrides
     */
    interface Schema$V1Beta1ImportProducerOverridesResponse {
        /**
     ...
     * A quota override
     */
    interface Schema$V1Beta1QuotaOverride {
        /**
     ...
     */
    interface Schema$V1Beta1RefreshConsumerResponse {
    }
    /**
     * Response message for the `DisableConsumer` method. This response message is assigned to the `response` field of the returned Operation when that operation is done.
     */
    interface Schema$V1DisableConsumerResponse {
    }
    /**
     * Response message for the `EnableConsumer` method. This response message is assigned to the `response` field of the returned Operation when that operation is done.
     */
    interface Schema$V1EnableConsumerResponse {
    }
    /**
     ...
     */
    interface Schema$V1GenerateServiceAccountResponse {
        /**
     ...
     * Response message for the `RefreshConsumer` method. This response message is assigned to the `response` field of the returned Operation when that operation is done.
     */
    interface Schema$V1RefreshConsumerResponse {
    }
    /**
     ...
     */
    interface Schema$V1RemoveVisibilityLabelsResponse {
        /**
         * The updated set of visibility labels for this consumer on this service.
         */
        labels?: string[];
     ...
     */
    interface Schema$V1ServiceAccount {
        /**
