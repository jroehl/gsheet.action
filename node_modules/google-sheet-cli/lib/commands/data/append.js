...
class UpdateData extends base_class_1.default {
    async run() {
        const { args: { data }, flags: { minCol, worksheetTitle = '', spreadsheetId, valueInputOption }, } = this.parse(UpdateData);
        try {
            ...
            const options = { worksheetTitle, minCol, valueInputOption };
...
UpdateData.description = 'Append cells with the specified data after the last row in starting col';
UpdateData.examples = [
...
UpdateData.flags = Object.assign(Object.assign({}, base_class_1.default.flags), { worksheetTitle: base_class_1.worksheetTitle,
    ...
    valueInputOption: base_class_1.valueInputOption, minCol: command_1.flags.integer({ description: 'The optional starting col of the operation', default: 1, required: false }) });
